...
{
    public partial class mdiBookings : Form
    {
        ...
        {
            //create an object based on frmView
            FrmView BookingsList = new FrmView();
            //make an object a child of the parent
        ...
        private void MDIBookings_Load(object sender, EventArgs e)
        {
